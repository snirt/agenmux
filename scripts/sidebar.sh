...
EOF
  ...
  frame="$E[H$E[1magents$E[0m$E[2m$filter_info$E[0m$NOTICE$E[K$NL$E[2m$header_hint$E[0m$E[K$NL"
...
$E[1mkeys$E[0m$NL\
 ...
 /        live text search$NL\
 b/w/i/d  filter blocked/working/idle/done$NL\
 a        show all agents$NL\
